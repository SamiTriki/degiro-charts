...
const csvTransactionToDate = (csvTransaction : any) => {
...
function transactionsFromCSV(CSVResults : any[]) {
  let transactions : Transaction[] = CSVResults
    .filter(t => t)
...
const transactionsPerPeriod = (transactions: Transaction[], period = 'day') =>
