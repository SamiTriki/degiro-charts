...
describe('Decorate transactions', () => {
  it('Correctly categorises a deposit', () => {
    ...
    let notDeposits = decorateTransactions([
      { description: 'Looks like a deposit but isnnt' },
      { description: 'buy 3 some company Deposit deposit at some sum' },
    ])
  ...
  it('Correctly categorises a withdrawal', () => {
    ...
    let notWithdrawal = decorateTransactions([
      { description: 'Looks like a withdrawal but isnnt' },
      {
        description: 'buy 3 some company Withdrawal withdrawal ltd at some sum',
      },
    ])
  ...
  it('Correctly categorises a interest', () => {
    let interest = decorateTransactions([
      { description: 'Money Market fund conversion: Sell 329.32 at 1 GBP' },
      { description: 'Fund Distribution' },
    ])
    let notInterest = decorateTransactions([
      { description: 'Buy some money market fund share at 300gbp' },
      { description: 'Buy some fund distribution at 300gbp' },
    ])
  ...
  it('Correctly categorises a dividend', () => {
    let dividend = decorateTransactions([
      { description: 'Dividend' },
      { description: 'Capital return' },
    ])
    let notdividend = decorateTransactions([
      { description: 'Buy some Dividend that doesnt makes sense' },
      {
        description: 'Buy some Capital Return which doesnt makes sense either',
      },
    ])
  ...
  it('Correctly categorises a fx', () => {
    let fx = decorateTransactions([
      { description: 'FX Credit' },
      { description: 'FX Debit' },
    ])
    let notfx = decorateTransactions([
      { description: 'Buy some FX Credit ltd' },
      { description: 'Buy some FX Debit ltd' },
    ])
  ...
  it('Correctly categorises a fee', () => {
    let fee = decorateTransactions([
      { description: 'DEGIRO signup Fee' },
      { description: 'New customer Reimbursement' },
      { description: 'degiro import fee' },
      { description: 'LSE stamp duty' },
      {
        description:
          'DEGIRO Exchange Connection Fee 2021 (New York Stock Exchange - NSY)',
      },
    ])
    let notfee = decorateTransactions([
      { description: 'Buy some fee clochette ltd' },
      { description: 'Buy some call of duty' },
      { description: 'some random string that finishes with fee' },
    ])
  ...
  describe('buy', () => {
    let buy = decorateTransactions([
      {
        description:
          'Buy 200 SUPERGROCERIES (PLCSMH)@198.15 GBX (GB000000001FAKE)',
      },
      {
        description:
          'Buy 2 SUPERSCIENCE SCIENTIFIC@516.1 USD (US000000SUPERFAKE)',
      },
      { description: 'Buy 1 MEGACORP C@78 USD (USXXXXWYYYYYFAKE)' },
    ])
    let notBuy = decorateTransactions([
      {
        description:
          'Buy 200 SUPERGROCERIES (PLCSMH) forinsteadofatsign 198.15 GBX (GB000000001FAKE)',
      },
      {
        description:
          'Buy 200 SUPERGROCERIES (PLCSMH) @198.15 NOCURRENCY (GB000000001FAKE)',
      },
      {
        description:
          'Buy NOSHARESCOUNT SUPERGROCERIES (PLCSMH) @198.15 GBX (GB000000001FAKE)',
      },
      {
        description:
          'Buy 200 SUPERGROCERIES (PLCSMH) @noprice GBX (GB000000001FAKE)',
      },
    ])
    ...
    it('Assigns the share count price and currency properly', () => {
      ...
      expect(buy[1].sharePrice).toBeCloseTo(516.1)
  ...
  describe('sell', () => {
    let sell = decorateTransactions([
      {
        description:
          'Sell 200 SUPERGROCERIES (PLCSMH)@198.15 GBX (GB000000001FAKE)',
      },
      {
        description:
          'Sell 2 SUPERSCIENCE SCIENTIFIC@516.1 USD (US000000SUPERFAKE)',
      },
      { description: 'Sell 1 MEGACORP C@78 USD (USXXXXWYYYYYFAKE)' },
    ])
    let notSell = decorateTransactions([
      {
        description:
          'Sell 200 SUPERGROCERIES (PLCSMH) forinsteadofatsign 198.15 GBX (GB000000001FAKE)',
      },
      {
        description:
          'Sell 200 SUPERGROCERIES (PLCSMH) @198.15 NOCURRENCY (GB000000001FAKE)',
      },
      {
        description:
          'Sell NOSHARESCOUNT SUPERGROCERIES (PLCSMH) @198.15 GBX (GB000000001FAKE)',
      },
      {
        description:
          'Buy 200 SUPERGROCERIES (PLCSMH) @noprice GBX (GB000000001FAKE)',
    ...
    it('Assigns the share count price and currency properly', () => {
      ...
      expect(sell[1].sharePrice).toBeCloseTo(516.1)
  ...
  it('Marks transaction as unknown when undetected', () => {
    let oddTransactions = decorateTransactions([
      { description: 'something' },
      { description: 'some odd buy' },
      { description: 'some odd sell' },
    ])
